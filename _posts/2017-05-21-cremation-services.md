...
<a href="{{ site.global.data.url }}/images/halve-home-image.png"><img src="{{ site.global.data.url }}/images/halve-home-image.png" alt="Home Page of Halve"></a>  
...
{% capture images %}
	{{ site.global.data.url }}/images/halve-home-image.png
	{{ site.global.data.url }}/images/post-image-halve-1.png
	{{ site.global.data.url }}/images/post-image-halve-2.png
{% endcapture %}
{% include gallery images=images caption="Screenshots of Halve Theme" cols=3 %}

{% capture images %}
	{{ site.global.data.url }}/images/post-image-halve-3.png
	{{ site.global.data.url }}/images/post-image-halve-6.png
	{{ site.global.data.url }}/images/post-image-halve-4.png
{% endcapture %}
...
![Halve Twitter Card]({{ site.global.data.url }}/images/post-image-halve-5.png)
